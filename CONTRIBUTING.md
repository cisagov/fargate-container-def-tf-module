...
issue](https://github.com/cisagov/fargate-container-def-tf-module/issues) in this
...
request](https://github.com/cisagov/fargate-container-def-tf-module/pulls), you
...
```console
cd fargate-container-def-tf-module
pyenv virtualenv <python_version_to_use> fargate-container-def-tf-module
pyenv local fargate-container-def-tf-module
